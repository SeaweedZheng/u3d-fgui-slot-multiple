        ...
        public static void OnBeforeCreat(Action onFinishCallback)
        {
            ...
            Action jsonFinishCB = () =>
            {
                FguiI18nManager.Instance.Add(I18nLang.cn,
                    "Assets/AstBundle/Consoles/Console Coin Pusher 97001000/ABs/I18ns/language_cn_console_coin_pusher_01.xml",
                    pkgName,
                    xmlFinishCB);
                FguiI18nManager.Instance.Add(I18nLang.tw,
                    "Assets/AstBundle/Consoles/Console Coin Pusher 97001000/ABs/I18ns/language_tw_console_coin_pusher_01.xml",
                    pkgName,
                    xmlFinishCB);
                FguiI18nManager.Instance.Add(I18nLang.en,
                    "Assets/AstBundle/Consoles/Console Coin Pusher 97001000/ABs/I18ns/language_en_console_coin_pusher_01.xml",
                    pkgName,
                    xmlFinishCB);
            };


            I18nMgr.Add("Assets/AstBundle/Consoles/Console Coin Pusher 97001000/ABs/I18ns/i18nConsoleCoinPusher01.json", pkgName, jsonFinishCB);
                        ...
                        MachineDataManager02.Instance.RequestCheckPassword(pwd, (Action<object>)((res) =>
                        {
                            ...
                            if (data.result == 0 && data.permissions > 0)
                            {
                                ...
                                if (SBoxModel.Instance.isCurPermissionsAdmin)
                                    ...
                                    SBoxModel.Instance.passwordStaff = pwd;
        ...
        void OnClickConfirm()
        {
            if (menuMap.ContainsKey(curIndexMenuItem))
            {
                ...
                switch (menuMap[curIndexMenuItem])
                {
                    case "record":
                        {
                            PageManager.Instance.OpenPage(PageName.ConsolePusher97001000PageConsoleRecordChoose);
                        }
                        return;
                    case "checkHardware":
                        {
                            PageManager.Instance.OpenPage(PageName.ConsolePusher97001000PageConsoleCheckHardware);
                        }
                        return;
                    case "checkCoinPush":
                        {
                            PageManager.Instance.OpenPage(PageName.ConsolePusher97001000PageConsoleTestCoinPush);
                        }
                        return;
                    case "settings":
                        {
                            PageManager.Instance.OpenPage(PageName.ConsolePusher97001000PageConsoleSettings);
                        }
                        return;
                    case "admin":
                        {
                            PageManager.Instance.OpenPage(PageName.ConsolePusher97001000PageConsoleAdmin);
                        }
                        return;
                    case "language":
                        {
