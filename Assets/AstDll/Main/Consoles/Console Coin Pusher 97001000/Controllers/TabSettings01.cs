...
namespace ConsoleCoinPusher97001000
{
    public class TabSettings01 : ConsoleTabMenuBase
    {
        ...
        {
            EventData res = await PageManager.Instance.OpenPageAsync(PageName.ConsolePusher97001000PageConsoleSetParameter002,
        ...
        {
            EventData res = await PageManager.Instance.OpenPageAsync(PageName.ConsolePusher97001000PageConsoleSetParameter001,
            new EventData<Dictionary<string, object>>("",
                new Dictionary<string, object>()
                {
