...
namespace ConsoleCoinPusher97001000
{
    public class TabSettings01 : ConsoleTabMenuBase
    {
        ...
        public new void InitParam(GComponent comp, Action onClickPrev, Action onClickNext, Action onClickExitCallback, bool isStartTab, bool isEndTab) //频繁调用-多语言
        {
            ...
            goOwnerMenu.GetChild("remoteCtrlEnable").asCom.GetChild("value").text = SBoxModel.Instance.isUseRemoteControl ? I18nMgr.T("ON") : I18nMgr.T("OFF");
        ...
        {
            OutParamsBase res = await PageManager.Instance.OpenPageAsync(PageName.ConsolePusher97001000PageConsoleSetParameter002,
                /*
        ...
        {
            OutParamsBase res = await PageManager.Instance.OpenPageAsync(PageName.ConsolePusher97001000PageConsoleSetParameter001,
                /*
                new EventData<Dictionary<string, object>>("",
                new Dictionary<string, object>()
                {
        ...
        void onClickButtonOnline()
        {
            ...
            goOwnerMenu.GetChildAt(curIndexMenuItem).asCom.GetChild("value").text = SBoxModel.Instance.isUseRemoteControl ? I18nMgr.T("ON") : I18nMgr.T("OFF");
        ...
        void OnClickCoder()
        {
            EventCenter.Instance.EventTrigger<EventData>(MachineUIEvent.ON_MACHINE_UI_EVENT,
                new EventData<PageName>(MachineUIEvent.ShowCoding, PageName.ConsolePusher97001000PageConsoleCoder));
            //new EventData<string>(MachineUIEvent.ShowCoding, "ConsolePusher97001000PageConsoleCoder"));
        }
