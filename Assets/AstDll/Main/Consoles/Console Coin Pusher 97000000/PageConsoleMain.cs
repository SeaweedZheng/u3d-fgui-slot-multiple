        ...
        void OnClickConfirm()
        {
            if (menuMap.ContainsKey(curIndexMenuItem))
            {
                ...
                switch (menuMap[curIndexMenuItem]) {
                    case "record":
                        {
                            PageManager.Instance.OpenPage(PageName.ConsolePusher97000000PageConsoleRecordChoose);
                        }
                        return;
                    case "checkHardware":
                        {
                            PageManager.Instance.OpenPage(PageName.ConsolePusher97000000PageConsoleCheckHardware02);
                        }
                        return;
                    case "checkCoinPush":
                        {
                    ...
                    case "admin":
                        {
                            PageManager.Instance.OpenPage(PageName.ConsolePusher97000000PageConsoleAdmin);
                        }
                        return;
                    case "language":
                        {
