...
namespace ConsoleCoinPusher97000000
{
    public class PageConsoleCheckHardware02 : MachinePageBase
    {
        ...
        {
            PageTitleManager.Instance.AddPageNode("Hardware Test");
        ...
        void CycleReadFlag(object obj)
        {
            /* PusherMachineDataManager02.Instance.RequestGetCoinPushHardwareFlag((res) =>
             {
                 ...
                 int bit0 = (int)jsonNode["flag"] & 1; bool isCoinDown = bit0 != 0;
                 int bit1 = (int)jsonNode["flag"] & 2; bool isBallDown = bit1 != 0;
                 goMenu.GetChild("topCoinIn").asCom.GetChild("value1").asRichTextField.text = isCoinDown ? I18nMgr.T("ON") : I18nMgr.T("OFF");

                 goMenu.GetChild("ballIn").asCom.GetChild("value1").asRichTextField.text = isBallDown ? I18nMgr.T("ON") : I18nMgr.T("OFF");
            ...
            goMenu.GetChild("topCoinIn").asCom.GetChild("value1").asRichTextField.text = isTestCoinDown ? I18nMgr.T("ON") : I18nMgr.T("OFF");

            goMenu.GetChild("ballIn").asCom.GetChild("value1").asRichTextField.text = isTestBallDown ? I18nMgr.T("ON") : I18nMgr.T("OFF");
            ...
            PusherMachineDataManager02.Instance.RequestGetCoinPushHardwareResult((res) =>
            {
                ...
                if (coin > 0)
                {
                    goMenu.GetChild("topCoinIn").asCom.GetChild("value2").asRichTextField.text = I18nMgr.T("ON");
                    Timers.inst.Add(0.2f, 1, (object obj) =>
                    {
                        goMenu.GetChild("topCoinIn").asCom.GetChild("value2").asRichTextField.text = I18nMgr.T("OFF");
                    });
                }

                if (ball > 0)
                {
                    goMenu.GetChild("ballIn").asCom.GetChild("value2").asRichTextField.text = I18nMgr.T("ON");
                    Timers.inst.Add(0.2f, 1, (object obj) =>
                    {
                        goMenu.GetChild("ballIn").asCom.GetChild("value2").asRichTextField.text = I18nMgr.T("OFF");
                    });
                }
                if (regainCoin > 0)
                {
                    goMenu.GetChild("RegainCoins").asCom.GetChild("value2").asRichTextField.text = I18nMgr.T("ON");
                    Timers.inst.Add(0.2f, 1, (object obj) =>
                    {
                        goMenu.GetChild("RegainCoins").asCom.GetChild("value2").asRichTextField.text = I18nMgr.T("OFF");
                    });
                }

                if (regainball > 0)
                {
                    goMenu.GetChild("RegainBalls").asCom.GetChild("value2").asRichTextField.text = I18nMgr.T("ON");
                    Timers.inst.Add(0.2f, 1, (object obj) =>
                    {
                        goMenu.GetChild("RegainBalls").asCom.GetChild("value2").asRichTextField.text = I18nMgr.T("OFF");
                    });
                }
                ...
                goWiper.asCom.GetChild("value1").asRichTextField.text = isTestWiper ? I18nMgr.T("ON") : I18nMgr.T("OFF");
                goMenu.GetChild("pushPlate").asCom.GetChild("value1").asRichTextField.text = isTestPlate ? I18nMgr.T("ON") : I18nMgr.T("OFF");
            ...
            PusherMachineDataManager02.Instance.RequestGetCoinPushHardwareState((res) =>
            {
                ...
                this.contentPane.GetChild("tip").asRichTextField.text = "掉币" + neww[1] + "掉球" + neww[2] + "推盘" + neww[3] + "雨刷" + neww[4];
                goMenu.GetChild("ballIn").asCom.GetChild("value3").asRichTextField.text = new_old2.ToString();
                goMenu.GetChild("wiper").asCom.GetChild("value1").asRichTextField.text = new_old4 == true ? I18nMgr.T("ON") : I18nMgr.T("OFF");
                goMenu.GetChild("pushPlate").asCom.GetChild("value1").asRichTextField.text = new_old3 == true ? I18nMgr.T("ON") : I18nMgr.T("OFF");
        ...
        void CoinInNum(int n)
        {
            ...
            if (n == 0)
            {
                goMenu.GetChild("topCoinIn").asCom.GetChild("value1").asRichTextField.text = I18nMgr.T("OFF");
                return;
            }
        ...
        void BonusNum(int n)
        {
            if (n == 0)
            {
                goMenu.GetChild("ballIn").asCom.GetChild("value1").asRichTextField.text = I18nMgr.T("OFF");
                return;
            }
        ...
        void CheckUI()
        {
            goMenu.GetChild("topCoinIn").asCom.GetChild("value1").asRichTextField.text = isTestCoinDown ? I18nMgr.T("ON") : I18nMgr.T("OFF");
            goMenu.GetChild("ballIn").asCom.GetChild("value1").asRichTextField.text = isTestBallDown ? I18nMgr.T("ON") : I18nMgr.T("OFF");
            goWiper.text = isTestWiper ? I18nMgr.T("ON") : I18nMgr.T("OFF");
            goMenu.GetChild("pushPlate").asCom.GetChild("value1").asRichTextField.text = isTestPlate ? I18nMgr.T("ON") : I18nMgr.T("OFF");
            goCoin.GetChild("value1").text = isTestRegainCoins ? I18nMgr.T("ON") : I18nMgr.T("OFF");
            goBall.GetChild("value1").text = isTestRegainBalls ? I18nMgr.T("ON") : I18nMgr.T("OFF");
        }
