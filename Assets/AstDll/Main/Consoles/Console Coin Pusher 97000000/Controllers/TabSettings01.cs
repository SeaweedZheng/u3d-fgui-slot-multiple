    ...
    public class TabSettings01 : ConsoleTabMenuBase
    {
        ...
        void OnClickCoder()
        {
            EventCenter.Instance.EventTrigger<EventData>(MachineUIEvent.ON_MACHINE_UI_EVENT,
                new EventData<PageName>(MachineUIEvent.ShowCoding, PageName.ConsolePusher97000000PageConsoleCoder));
            //new EventData<string>(MachineUIEvent.ShowCoding, "ConsolePusher97000000PageConsoleCoder"));
        }
