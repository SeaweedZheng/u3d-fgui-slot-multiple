...
{ 
    public class PageConsoleCheckHardware : MachinePageBase
    {
        ...
        void CollectCoinNum(int n)
        {
            if (n == 0)
            {
                goMenu.GetChild("collectCoin").asCom.GetChild("value1").asRichTextField.text = I18nMgr.T("OFF");
                return;
            }
        ...
        void TicketerNum(int n)
        {
            if (n == 0)
            {
                goMenu.GetChild("ticketer").asCom.GetChild("value1").asRichTextField.text = I18nMgr.T("OFF");
                return;
            }
        ...
        void LightSpin()
        {
            ...
            {
                int state = (int)res;
                goMenu.GetChildAt(curIndexMenuItem).asCom.GetChild("value1").asRichTextField.text = state == 1 ? I18nMgr.T("ON") : I18nMgr.T("OFF");
            });
