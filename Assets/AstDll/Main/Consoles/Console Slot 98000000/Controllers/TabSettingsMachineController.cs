...
using static ConsoleSlot98000000.PasswordSettingController;
...
public class TabSettingsMachineController
{
    ...
    /// 修改用户密码
    PasswordSettingController adminChangePwdCtrl = new PasswordSettingController(UserType.Admin);
    PasswordSettingController managerChangePwdCtrl = new PasswordSettingController(UserType.Manager);
    PasswordSettingController shiftChangePwdCtrl = new PasswordSettingController(UserType.Staff);
