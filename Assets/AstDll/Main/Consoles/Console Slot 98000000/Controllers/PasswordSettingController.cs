...
namespace ConsoleSlot98000000
{
    public class PasswordSettingController
    {
        ...
        public PasswordSettingController(UserType userTp)
        {
            userType = userTp;
        }
                ...
                case StepGoBackPermissions.CheckPopClose:
                    {
                        ...
                        if (PageManager.Instance.IndexOf(PageName.ConsoleSlot98000000PopupConsoleKeyboard001) == -1
                            && PageManager.Instance.IndexOf(PageName.ConsoleSlot98000000PopupConsoleSetParameter002) == -1)
                        {
                ...
                case StepGoBackPermissions.GoBackPermissions:
                    {
                        ...
                        int pwd = SBoxModel.Instance.curPermissions == 3 ? SBoxModel.Instance.passwordAdmin :
                            ...
                            SBoxModel.Instance.curPermissions == 1 ? SBoxModel.Instance.passwordStaff : -1;
