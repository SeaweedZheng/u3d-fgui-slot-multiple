...
namespace ConsoleSlot98000000
{
    ...
    public class PageConsoleSettingsRecord : PageBase
    {
        public const string pkgName = "ConsoleSlot98000000";
        public const string resName = "PageConsoleSettingsRecord";
        ...
        SettingRecordView settingRecordView = new SettingRecordView();
        SettingRecordPresenter settingRecordPresenter = new SettingRecordPresenter();
        public override void InitParam()
        {
            ...
            settingRecordView.InitParam(tab);
            settingRecordPresenter.InitParam(settingRecordView);
