...
namespace ConsoleSlot98000000
{
    public class PageConsoleLogRecord : PageBase
    {
        ...
        public override void InitParam()
        {
            ...
            tabEventRecordCtrl.InitParam(this.contentPane.GetChild("tabs").asCom.GetChildAt(0).asCom, ConsoleTableName.TABLE_LOG_EVENT_RECORD);
            tabErrorRecordCtrl.InitParam(this.contentPane.GetChild("tabs").asCom.GetChildAt(1).asCom, ConsoleTableName.TABLE_LOG_ERROR_RECORD);
        }
    }
}
