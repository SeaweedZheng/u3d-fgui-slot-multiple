...
namespace ConsoleSlot98000000
{
    public class PageConsoleGameInformation : PageBase
    {
        ...
        public override void InitParam()
        {
            ...
            cmpSoftwareVer.GetChild("value").asRichTextField.text = $"{ApplicationSettings.Instance.appVersion}/{GlobalModel.hotfixVersion}";
        ...
        StreamingAssetsBundleLoader.Instance.LoadAsset<Texture2D>(ConfigUtils.curGameAvatarURL,
            ...
            //"Assets/AstBundle/_Commons/Game Maker/ABs/152/Game Icon/PssOn00152.png",
            (Texture2D texture) =>
            {
