...
{
    public class PageConsoleSettingsRemoteControl : PageBase
    {
        public const string pkgName = "ConsoleSlot98000000";
        public const string resName = "PageConsoleSettingsRemoteControl";
        ...
        public override void OnOpen(PageName name, InParamsBase data)
        {
            ...
            // 添加事件监听
            settingRemoteControlPresenter.Enable();
        ...
        public override void OnClose(OutParamsBase data = null)
        {
            ...
            // 删除事件监听
            settingRemoteControlPresenter.Disable();
        ...
        SettingRemoteControlView settingRemoteControlView = new SettingRemoteControlView();
        SettingRemoteControlPresenter settingRemoteControlPresenter = new SettingRemoteControlPresenter();
        public override void InitParam()
        {
            ...
            settingRemoteControlView.InitParam(tab);
            settingRemoteControlPresenter.InitParam(settingRemoteControlView);
        }
    }
