    ...
    public static TableSysSettingItem[] DefaultTable()
    {
        ...
        return new TableSysSettingItem[]{
            new TableSysSettingItem()
            {
                ...
                is_debug = DefaultSettingsUtils.isDebugLog,

                enable_reporter_page = DefaultSettingsUtils.isUseReporterPage,
...
public class TableSlotGameRecordItem
{
    ...
    public string spin_type = "";  //【新版本用】 "spin", "free_spin"  "bonus_minigame"
    ...
    public long base_spin_win_credit = 0;
    ...
    public long bonus_win_credit = 0;
...
public class TableCoinPusherGameRecordItem
{
    public long id;
    /// <summary> 玩家id </summary>
    public string user_id = "";
...
public class TableGameRecordItem
{
    ...
    public string win_unit = "credit"; // "coin"

    /// <summary> 基础游戏赢分 (可以是普通局 或 免费局)</summary>
    public long base_game_win = 0;

    /// <summary> 免费游戏赢分 </summary>
    //public long free_spin_win_coins = 0;

    /// <summary> 彩金赢分 </summary>
    public long jackpot_win = 0;
    public string jackpot_type = "";

    /// <summary> 小游戏赢分 </summary>
    public long bonus_game_win = 0;
    public string bonus_game_type = "";
