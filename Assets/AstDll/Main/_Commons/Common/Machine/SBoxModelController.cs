...
public class SBoxModelController : MonoSingleton<SBoxModelController>
{
    ...
    IEnumerator OnInitParam() { 
        ...
        */
        ...
        /*
        // 加载多语言文件
        ConsoleCoinPusher01.PageConsoleMain.OnBeforeCreat(() =>
        {
            isNext = true;
        });
        yield return new WaitUntil(() => isNext == true);
        ...
        */
        ...
        // 加载多语言文件
        I18nMgr.Add("Assets/AstBundle/Consoles/Console Coin Pusher 97000000/ABs/I18ns/i18nConsoleCoinPusher01.json",
            "Common", 
            () =>
            {
                isNext = true;
