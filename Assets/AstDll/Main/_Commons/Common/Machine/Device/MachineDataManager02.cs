...
public partial class MachineDataManager02: ProxyHelper<MachineDataManager02>
{
    ...
    /// <summary> 获取游戏彩金 </summary>
    public int RequestJackpotOnLine(JackBetInfo req)
    {
        //int seqId = OnRequestBefore(RpcNameJackpotOnLine, null, null, null, null);

        int seqId = -1;
        OnDebugRpcUp(RpcNameJackpotOnLine, req);
    ...
    const string RpcNameIsBillerConnect = nameof(RpcNameIsBillerConnect);
