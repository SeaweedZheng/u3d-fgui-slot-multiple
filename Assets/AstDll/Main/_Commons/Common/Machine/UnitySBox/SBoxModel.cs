...
public class SBoxModel: MonoSingleton<SBoxModel>
{
    ...
    */
    ...
    {
        get => SboxConfData.BallValue;
        set => SboxConfData.BallValue = value;
    }
...
*/
    ...
    public string BillInfoHardwareAlgorithmVer
    {
        get
        {
            ...
            return $"{GlobalModel.hotfixVersion}/{AlgorithmVer}/{DifficultyName}/{tempStr}";
        }
    }
    ...
    public string language
    {
        ...
        {
            if (_language == null)
                _language = SQLitePlayerPrefs03.Instance.GetString(PARAM_LANGUAGE, DefaultSettingsUtils.defLanguage);
            return _language;
        }
        set
        {
            ...
            {
                _language = value;
                SQLitePlayerPrefs03.Instance.SetString(PARAM_LANGUAGE, value);
            }
        }
    }
    string _language = null;
    const string PARAM_LANGUAGE = "PARAM_LANGUAGE";
    ...
    public int gameRecordMax
    {
        get
        {
            if (m_GameRecordMax == null)
                m_GameRecordMax = SQLitePlayerPrefs03.Instance.GetInt(PARAM_GAME_RECORD_MAX, DefaultSettingsUtils.defMaxGameRecord);
            return (int)m_GameRecordMax;
        }
        set
        {
            m_GameRecordMax = value;
            SQLitePlayerPrefs03.Instance.SetInt(PARAM_GAME_RECORD_MAX, value);
        }
    }
    const string PARAM_GAME_RECORD_MAX = "PARAM_GAME_RECORD_MAX";
    [SerializeField]
    int? m_GameRecordMax;


    /// <summary> 最投退币记录次数 </summary>
    public int coinInOutRecordMax
    {
        get
        {
            if (m_CoinInOutRecordMax == null)
                m_CoinInOutRecordMax = SQLitePlayerPrefs03.Instance.GetInt(PARAM_COIN_IN_OUT_RECORD_MAX, DefaultSettingsUtils.defMaxCoinInOutRecord);
            return (int)m_CoinInOutRecordMax;
        }
        set
        {
            m_CoinInOutRecordMax = value;
            SQLitePlayerPrefs03.Instance.SetInt(PARAM_COIN_IN_OUT_RECORD_MAX, value);
        }
    }
    const string PARAM_COIN_IN_OUT_RECORD_MAX = "PARAM_COIN_IN_OUT_RECORD_MAX";
    [SerializeField]
    int? m_CoinInOutRecordMax;



    /// <summary> 最大报警信息记录局数 </summary>
    public int errorRecordMax
    {
        get
        {
            if (m_ErrorRecordMax == null)
                m_ErrorRecordMax = SQLitePlayerPrefs03.Instance.GetInt(PARAM_ERROR_RECORD_MAX, DefaultSettingsUtils.defMaxErrorRecord);
            return (int)m_ErrorRecordMax;
        }
        set
        {
            m_ErrorRecordMax = value;
            SQLitePlayerPrefs03.Instance.SetInt(PARAM_ERROR_RECORD_MAX, value);
        }
    }
    const string PARAM_ERROR_RECORD_MAX = "PARAM_ERROR_RECORD_MAX";
    [SerializeField]
    int? m_ErrorRecordMax;



    /// <summary> 最大事件信息记录局数 </summary>
    public int eventRecordMax
    {
        get
        {
            if (m_EventRecordMax == null)
                m_EventRecordMax = SQLitePlayerPrefs03.Instance.GetInt(PARAM_EVENT_RECORD_MAX, DefaultSettingsUtils.defMaxEventRecord);
            return (int)m_EventRecordMax;
        }
        set
        {
            m_EventRecordMax = value;
            SQLitePlayerPrefs03.Instance.SetInt(PARAM_EVENT_RECORD_MAX, value);
        }
    }
    const string PARAM_EVENT_RECORD_MAX = "PARAM_EVENT_RECORD_MAX";
    [SerializeField]
    int? m_EventRecordMax;




    /// <summary> 最大彩金记录局数 </summary>
    public int jackpotRecordMax
    {
        get
        {
            if (m_JackpotRecordMax == null)
                m_JackpotRecordMax = SQLitePlayerPrefs03.Instance.GetInt(PARAM_JACKPOT_RECORD_MAX, DefaultSettingsUtils.defMaxJackpotRecord);
            return (int)m_JackpotRecordMax;
        }
        set
        {
            m_JackpotRecordMax = value;
            SQLitePlayerPrefs03.Instance.SetInt(PARAM_JACKPOT_RECORD_MAX, value);
        }
    }
    const string PARAM_JACKPOT_RECORD_MAX = "PARAM_JACKPOT_RECORD_MAX";
    [SerializeField]
    int? m_JackpotRecordMax;


    /// <summary> 最大盈利天数记录 </summary>
    public int businiessDayRecordMax
    {
        get
        {
            if (m_BusiniessDayRecordMax == null)
                m_BusiniessDayRecordMax = SQLitePlayerPrefs03.Instance.GetInt(PARAM_BUSINIESS_DAY_RECORD_MAX, DefaultSettingsUtils.defMaxBusinessDayRecord);
            return (int)m_BusiniessDayRecordMax;
        }
        set
        {
            m_BusiniessDayRecordMax = value;
            SQLitePlayerPrefs03.Instance.SetInt(PARAM_BUSINIESS_DAY_RECORD_MAX, value);
        }
    }
    const string PARAM_BUSINIESS_DAY_RECORD_MAX = "PARAM_BUSINIESS_DAY_RECORD_MAX";
    [SerializeField]
    int? m_BusiniessDayRecordMax;
    ...
    public bool isUseIot
    {
        get
        {
            if (ApplicationSettings.Instance.isRelease) return false; //正式包不放出去
    ...
    public bool isDebugLog
    {
        get
        {
           ...
           if (ApplicationSettings.Instance.isRelease)  return false;
            ...
            if (m_IsDebugLog == null)
                m_IsDebugLog = SQLitePlayerPrefs03.Instance.GetInt(PARAM_IS_DEBUG_LOG, DefaultSettingsUtils.isDebugLog) == 1;

            return (bool)m_IsDebugLog;
        }
        set
        {
            //#seaweed#
            ...
            SQLitePlayerPrefs03.Instance.SetInt(PARAM_IS_DEBUG_LOG, value ? 1 : 0);
    ...
    public bool isUpdateInfo
    {
        ...
        {
            if (m_IsDebugLog == null)
                m_IsDebugLog = SQLitePlayerPrefs03.Instance.GetInt(PARAM_IS_UPDATE_INFO, DefaultSettingsUtils.isUpdateInfo) == 1;

            return (bool)m_IsUpdateInfo;
        }
        set
        {
            SQLitePlayerPrefs03.Instance.SetInt(PARAM_IS_UPDATE_INFO, value ? 1 : 0);
            m_IsDebugLog = value;
        }
    }
    const string PARAM_IS_UPDATE_INFO = "PARAM_IS_UPDATE_INFO";
    [SerializeField]
    bool? m_IsUpdateInfo;
    ...
    public bool isUseReporterPage
    {
        get
        {
            ...
            if (m_IsUseReporterPage == null)
                m_IsUseReporterPage = SQLitePlayerPrefs03.Instance.GetInt(PARAM_IS_USE_REPORTER_PAGE, DefaultSettingsUtils.isUseReporterPage) == 1;

            return (bool)m_IsUseReporterPage;
        }
        set
        {
            //#seaweed#
            ...
            SQLitePlayerPrefs03.Instance.SetInt(PARAM_IS_USE_REPORTER_PAGE, value ? 1 : 0);
            m_IsUseReporterPage = value;
            //observable.SetProperty(ref m_IsUseReporterPage, value);
        }
    }
    const string PARAM_IS_USE_REPORTER_PAGE = "PARAM_IS_USE_REPORTER_PAGE";
    [SerializeField]
    bool? m_IsUseReporterPage;
    ...
    public bool isUseTestTool
    {
        get
        {
            ...
            if (m_IsUseTestTool == null)
                m_IsUseTestTool = SQLitePlayerPrefs03.Instance.GetInt(PARAM_IS_USE_TEST_TOOL, DefaultSettingsUtils.isDebugLog) == 1;

            return (bool)m_IsUseTestTool;
        }
        set
        {
            //#seaweed#
            ...
            SQLitePlayerPrefs03.Instance.SetInt(PARAM_IS_USE_TEST_TOOL, value ? 1 : 0);

            m_IsUseTestTool = value;
            //observable.SetProperty(ref m_IsUseTestTool, value);
        }
    }
    const string PARAM_IS_USE_TEST_TOOL = "PARAM_IS_USE_TEST_TOOL";
    [SerializeField]
    bool? m_IsUseTestTool;
    ...
    /// <summary> 是否显示测试工具 </summary>
    public bool isUpdateAtEnterGame
    {
        get
        {
            //#seaweed#
            ...
            if (m_IsUpdateAtEnterGame == null)
                m_IsUpdateAtEnterGame = SQLitePlayerPrefs03.Instance.GetInt(PARAM_IS_UPDATE_AT_ENTER_GAME, 1) == 1;

            return (bool)m_IsUpdateAtEnterGame;
        }
        set
        {
            //#seaweed#
            ...
            SQLitePlayerPrefs03.Instance.SetInt(PARAM_IS_UPDATE_AT_ENTER_GAME, value ? 1 : 0);

            m_IsUpdateAtEnterGame = value;
            //observable.SetProperty(ref m_IsUpdateAtEnterGame, value);
        }
    }
    const string PARAM_IS_UPDATE_AT_ENTER_GAME = "PARAM_IS_UPDATE_AT_ENTER_GAME";
    [SerializeField]
    bool? m_IsUpdateAtEnterGame;
    ...
    public int jackpotScoreRate = 10000;  // 1 除以 币值 乘以 1000 整形   （联网彩金分值比 ：只能该币值）

    public int jackpotPercent = 5;  // 千分之几（1 - 100 可调 ；名称： 联网彩金比（千分）  ）
    #endregion
    /*
    /// <summary> 当前权限  1：普通密码权限，2：管理员密码权限，3：超级管理员密码权限</summary>
    public int curPermissions = -1;
    ...
    */
    ...
    /// <summary> 后台模块展示权限  </summary>
    public JArray consoleDisplayPermissions
    {
        get
        {
            if (_consoleDisplayPermissions == null)
            {
                //SQLitePlayerPrefs03.Instance.DeleteKey(PARAM_CONSOLE_DISPLAY_PERMISSIONS);

                string content = SQLitePlayerPrefs03.Instance.GetString(PARAM_CONSOLE_DISPLAY_PERMISSIONS, consoleDisplayPermissionsDefaultStr);
                _consoleDisplayPermissions = JArray.Parse(content);
            }
            return _consoleDisplayPermissions;
        }
        set
        {
            _consoleDisplayPermissions = value;
            SQLitePlayerPrefs03.Instance.SetString(PARAM_CONSOLE_DISPLAY_PERMISSIONS, JsonConvert.SerializeObject(_consoleDisplayPermissions));
        }
    }
    const string PARAM_CONSOLE_DISPLAY_PERMISSIONS = nameof(PARAM_CONSOLE_DISPLAY_PERMISSIONS);
    JArray _consoleDisplayPermissions = null;


    public string consoleDisplayPermissionsDefaultStr
    {
        get
        {
            /*
            if (_consoleDisplayPermissionsDefaultStr == null)
            {
            ...
            return _consoleDisplayPermissionsDefaultStr;
        }
        set
        {
            _consoleDisplayPermissionsDefaultStr = value;
        }
    }
    string _consoleDisplayPermissionsDefaultStr;
}
