...
namespace CoinPusherRichLegend2001003
{
    ...
    public class PageGameBonus2 : MachinePageBase
    {
        ...
        protected override void OnInit()
        {
            ...
            "Assets/AstBundle/Games/Coin Pusher Rich Legend 2001003/Prefabs/Page Game Bonus 2/ButtonHand.prefab",
            (GameObject clone) =>
            {
            ...
            ResourceManager02.Instance.LoadAsset<GameObject>(
            "Assets/AstBundle/Games/Coin Pusher Rich Legend 2001003/Prefabs/Page Game Bonus 2/RichMainJump.prefab",
            (GameObject clone) =>
            {
