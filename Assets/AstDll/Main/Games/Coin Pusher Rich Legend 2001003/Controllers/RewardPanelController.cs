...
namespace CoinPusherRichLegend2001003
{
    public class RewardPanelController
    {
        ...
        public void Enable()
        {
            ...
            MachineDataManagerG2001003.Instance.RequestCoinHit(0, (res) =>
            {
                winCoins = 0;
        ...
        public void InitParam(GComponent ui)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                items.Add(go);
                //go.GetChild("icon").asLoader.url = $"ui://RichLegend2001003/MVSymbolAppear{i + 1}";
                go.GetController("selectSymbol").selectedPage = $"symbol{i+1}";
        ...
        {
            MachineDataManagerG2001003.Instance.RequestCoinHit(winCoins, (res) =>
            {
                winCoins = 0;
                int[] result = res as int[];
