...
namespace CoinPusherRichLegend2001003
{
    public class PageGameLoading : MachinePageBase
    {
        ...
        {
            // 添加模块
            //ModuleDownloadManager.Instance.AddModeToRuning("RL2001003");
        ...
        private void EnterGame()
        {
            if(--callBackCount == 0)
            {
                PageManager.Instance.OpenPage(PageName.RichLegend2001003PageGameMain);
                CloseSelf(null);
            }
        }
        ...
        private void StartLoadingAnimation2()
        {
            ...
            // 预加载
            PageManager.Instance.PreloadPage(PageName.RichLegend2001003PageGameMain, () =>
            {
                EnterGame();
            });
