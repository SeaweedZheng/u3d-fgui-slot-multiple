    ...
    public class PopupBigWin : MachinePageBase
    {
        ...
        protected override void OnInit()
        {
            ...
            ResourceManager02.Instance.LoadAsset<GameObject>(
                "Assets/AstBundle/Games/Coin Pusher Emperors Rein 200/Prefabs/PopupBigWin/Begin Queen.prefab",
                clone =>
                {
                    go = clone;
            ...
            // 加载特效1
            ResourceManager02.Instance.LoadAsset<GameObject>(
                "Assets/AstBundle/Games/Coin Pusher Emperors Rein 200/Prefabs/PopupBigWin/BIgWinEffect01.prefab",
                clone =>
                {
            ...
            // 加载特效2
            ResourceManager02.Instance.LoadAsset<GameObject>(
                "Assets/AstBundle/Games/Coin Pusher Emperors Rein 200/Prefabs/PopupBigWin/BIgWinEffect02.prefab",
                clone =>
                {
