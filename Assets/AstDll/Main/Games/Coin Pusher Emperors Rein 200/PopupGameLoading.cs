...
namespace PusherEmperorsRein
{
    ...
    public class PopupGameLoading : MachinePageBase
    {
        ...
        {
            // 添加模块
            ModuleDownloadManager.Instance.AddModInfo("ER200");
            ...
            Action jsonFinishCB = () =>
            {
                ...
                FguiI18nManager.Instance.Add(I18nLang.cn,
                    "Assets/AstBundle/Games/Coin Pusher Emperors Rein 200/ABs/I18ns/language_cn_emperors_rein.xml",
                    pkgName,
                    xmlFinishCB);
                FguiI18nManager.Instance.Add(I18nLang.tw,
                    "Assets/AstBundle/Games/Coin Pusher Emperors Rein 200/ABs/I18ns/language_tw_emperors_rein.xml",
                    pkgName,
                    xmlFinishCB);
                FguiI18nManager.Instance.Add(I18nLang.en,
                    "Assets/AstBundle/Games/Coin Pusher Emperors Rein 200/ABs/I18ns/language_en_emperors_rein.xml",
                    pkgName,
                    xmlFinishCB);
            };

            // 加载json
            I18nMgr.Add("Assets/AstBundle/Games/Coin Pusher Emperors Rein 200/ABs/I18ns/i18nEmperorsRein200.json", pkgName, jsonFinishCB);
...
#if true
            // 延时等待遮罩关闭
            Timers.inst.Add(0.1f, 1,(pam)=>{
                if (PageManager.Instance.IndexOf(PageName.PusherEmperorsReinPopupGameLoading) == 0)
                {
    ...
    */
        ...
        {
            // 推币机-帝国之辉-预加载界面：
            PageManager.Instance.PreloadPage(PageName.PusherEmperorsReinPageGameMain, null);
            ...
            tweener = GTween.To(0, 100, duration)
                ...
                .OnComplete(() =>
                {
                    ...
                    {
                       PageManager.Instance.OpenPage(PageName.PusherEmperorsReinPageGameMain);
                    }
