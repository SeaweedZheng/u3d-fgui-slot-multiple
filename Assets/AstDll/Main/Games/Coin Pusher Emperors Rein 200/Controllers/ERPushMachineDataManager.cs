...
namespace PusherEmperorsRein
{
    ...
    public class ERPushMachineDataManager : MachineDataManager
    {
        ...
        public int RequestSetMajorGrandWin(int majorWins, int grandWins, Action<object> finishCallback)
        {
           ...
           return severHelper.RequestData(SBoxEventHandle.SBOX_COIN_PUSH_SET_MAJOR_GRAND_WIN, req, finishCallback, null);
        }
        ...
        public override object[] requestFunc(string rpcName, object req)
        {
            ...
            switch (rpcName)
            {
                ...
                case SBoxEventHandle.SBOX_COIN_PUSH_SET_MAJOR_GRAND_WIN:
                    {
                        Dictionary<string, object> data = (Dictionary<string, object>)req;
                        SBoxIdea.SetJpMajorGrandWin(SBoxModel.Instance.pid, (int)data["majorWins"], (int)data["grandWins"]);
                    }
                    return result;
            }
