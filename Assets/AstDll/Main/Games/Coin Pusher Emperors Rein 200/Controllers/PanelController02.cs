    ...
    public class PanelController02 : PusherMaker.PanelBaseController
    {
        ...
        public override void Init(EventData res = null)
        {
            ...
            */
            ...
            {
                ResourceManager02.Instance.LoadAssetBundleAsync("Assets/AstBundle/Games/Coin Pusher Emperors Rein 200/FGUIs", (ab) =>
                {
            ...
            ResourceManager02.Instance.LoadAsset<GameObject>("Assets/AstBundle/Games/Coin Pusher Emperors Rein 200/Prefabs/Spin/Push_btn_Spin.prefab",
           (GameObject clone) =>
           {
               goSpinClone = clone;
               loadComplete();
