...
namespace PusherEmperorsRein
{
    ...
    public class MachineDataG200Controller : MonoSingleton02<MachineDataG200Controller>
    {
        ...
        public void ParseJackpotGame(SBoxJackpotData sboxJackpotData)
        {
            ...
            jpAstBundle.curJackpotGrand = sboxJackpotData != null && sboxJackpotData.JackpotOut.Length >= 1 ? sboxJackpotData.JackpotOut[0] : 0;
            jpAstBundle.curJackpotMajor = sboxJackpotData != null && sboxJackpotData.JackpotOut.Length >= 2 ? sboxJackpotData.JackpotOut[1] : 0;
            jpAstBundle.curJackpotMinior = 1000;
            jpAstBundle.curJackpotMini = 500;
        }
        ...
        public void ParseSlotSpin(long totalBet, JSONNode res, SBoxJackpotData sboxJackpotData)
        {
            ...
            ContentModel.Instance.isHitJpGame1JpGame2 = (isJackpotGrand || isJackpotMajor);
            ContentModel.Instance.isHitJpGame3JpGame4 = isJackpotMinMinor;
