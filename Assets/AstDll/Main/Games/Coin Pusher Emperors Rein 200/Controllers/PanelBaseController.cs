...
namespace PusherMaker
{
    ...
    public class PanelBaseController : MonoBehaviour, IPanel
    {
        ...
        public virtual void Init(EventData res = null)
        {
            ...
            {
                ResourceManager02.Instance.LoadAssetBundleAsync("Assets/AstBundle/Games/Panel Coin Pusher 02/FGUIs", (ab) =>
                {
                    UIPackage.AddPackage(ab);
                    //GLoader anchorPanel = _goAnchorPanel.GetChild("icon").asLoader;
                    //anchorPanel.url = "ui://PanelCoinPusher02/Panel";
            ...
            ResourceManager02.Instance.LoadAsset<GameObject>("Assets/AstBundle/Games/Panel Slot 01/Prefabs/Slot_btn_Spin.prefab",
            (GameObject clone) =>
            {
                goSpinClone = clone;
                loadComplete();
        ...
        protected virtual void InitParam(EventData data = null)
        {
            ...
            if(goAnchorPanel != _goAnchorPanel || gOwnerPanel == null)
            {
                ...
                GLoader anchorPanel = _goAnchorPanel.GetChild("icon").asLoader;
                anchorPanel.url = "ui://PanelCoinPusher02/Panel";  // 内存泄漏？？
                gOwnerPanel = anchorPanel.component;
                gOwnerPanel.visible = true;
            }
