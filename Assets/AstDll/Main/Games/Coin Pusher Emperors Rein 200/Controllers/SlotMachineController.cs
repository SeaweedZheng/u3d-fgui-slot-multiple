...
namespace PusherEmperorsRein
{
    ...
    public partial class SlotMachineController : SlotMachineBaseController
    {
        ...
        public  void Init(GComponent gSlotCover, GComponent gPayLines,GComponent gReels, GComponent gExpectation,FguiGameObjectPoolHelper fguiPoolHelper, FguiGObjectPoolHelper gObjectPoolHelper)
        {
        ...
        public IEnumerator ShowSymbolBonusBySetting_LaBa (List<BonusWin> bonusWin, bool isUseMySelfSymbolNumber)
        {
            ...
            foreach (var item in bonusWin)
            {
                SymbolBase symble = GetVisibleSymbolFromDeck(item.cell.columnIndex, item.cell.rowIndex);
