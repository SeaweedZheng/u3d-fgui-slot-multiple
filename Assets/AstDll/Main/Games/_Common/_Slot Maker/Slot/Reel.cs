...
namespace SlotMaker
{
    ...
    public class Reel : ReelBase
    {
        ...
        protected int deckUpStartIndex => 1;
        protected int deckUpEndIndex => customModel.row;
        protected  int deckDownStartIndex => customModel.row + 1;
        protected int deckDownEndIndex => customModel.row + customModel.row;
