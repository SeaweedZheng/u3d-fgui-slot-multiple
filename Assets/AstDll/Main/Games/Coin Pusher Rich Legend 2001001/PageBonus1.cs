...
{
    public class PageBonus1 : MachinePageBase
    {
        public const string pkgName = "RichLegend2001001";
        public const string resName = "PageBonus1";
        ...
        protected override void OnInit()
        {
            ...
            "Assets/AstBundle/Games/Coin Pusher Rich Legend 2001001/Prefabs/Page Bonus 1/Train.prefab",
            (GameObject clone) =>
            {
                goTrainClone = clone;
                callback();
