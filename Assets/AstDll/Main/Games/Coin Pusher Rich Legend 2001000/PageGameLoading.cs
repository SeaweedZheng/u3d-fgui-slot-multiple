...
namespace CoinPusherRichLegend2001000
{
    public class PageGameLoading : MachinePageBase
    {
        ...
        {
            // 添加模块
            //ModuleDownloadManager.Instance.AddModeToRuning("RL2001000");
        ...
        {
            // 预加载
            PageManager.Instance.PreloadPage(PageName.RichLegend2001000PageGameMain, null);
            ...
            tweener2 = GTween.To(0, 1, 5.5f)
                ...
                .OnComplete(() =>
                {
                    ...
                    PageManager.Instance.OpenPage(PageName.RichLegend2001000PageGameMain);
                });
        }
    }
}