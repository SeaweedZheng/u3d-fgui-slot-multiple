...
namespace CoinPusherRichLegend2001000
{
    ...
    public class MockDataManagerG2001000 : MonoSingleton02<MockDataManagerG2001000>
    {
        ...
        private Dictionary<SpinDataType, List<string[]>> spinDatas = new Dictionary<SpinDataType, List<string[]>>()
        {
            ...
            {
                new string[] { "Assets/AstBundle/Games/Coin Pusher Rich Legend 2001000/ABs/Mock/g2001000__slot_spin__0.json" },
                new string[] { "Assets/AstBundle/Games/Coin Pusher Rich Legend 2001000/ABs/Mock/g2001000__slot_spin__1.json" },//单线
                new string[] { "Assets/AstBundle/Games/Coin Pusher Rich Legend 2001000/ABs/Mock/g2001000__slot_spin__2.json" },//多线
                new string[] { "Assets/AstBundle/Games/Coin Pusher Rich Legend 2001000/ABs/Mock/g2001000__slot_spin__3.json" },
                new string[] { "Assets/AstBundle/Games/Coin Pusher Rich Legend 2001000/ABs/Mock/g2001000__slot_spin__4.json" },
                new string[] { "Assets/AstBundle/Games/Coin Pusher Rich Legend 2001000/ABs/Mock/g2001000__slot_spin__5.json" },
                new string[] { "Assets/AstBundle/Games/Coin Pusher Rich Legend 2001000/ABs/Mock/g2001000__slot_spin__6.json" },
            },
            [SpinDataType.Jp1] = new List<string[]>()
            {
                new string[] { "Assets/AstBundle/Games/Coin Pusher Rich Legend 2001000/ABs/Mock/g2001000__slot_spin__jp1.json" },
            },
            [SpinDataType.Jp2] = new List<string[]>()
            {
                new string[] { "Assets/AstBundle/Games/Coin Pusher Rich Legend 2001000/ABs/Mock/g2001000__slot_spin__jp2.json" },
            },
            [SpinDataType.Jp3] = new List<string[]>()
            {
                new string[] { "Assets/AstBundle/Games/Coin Pusher Rich Legend 2001000/ABs/Mock/g2001000__slot_spin__jp3.json" },
            },

            [SpinDataType.JpConsole1] = new List<string[]>()
            {
                new string[] {"Assets/AstBundle/Games/Coin Pusher Rich Legend 2001000/ABs/Mock/g2001000__slot_spin__jpmega.json" },
            },
            [SpinDataType.Bonus1] = new List<string[]>()
            {
                new string[] {"Assets/AstBundle/Games/Coin Pusher Rich Legend 2001000/ABs/Mock/g2001000__slot_spin__bonus1.json"},
            },
            [SpinDataType.Bonus2] = new List<string[]>()
            {
                new string[] {"Assets/AstBundle/Games/Coin Pusher Rich Legend 2001000/ABs/Mock/g2001000__slot_spin__bonus2.json"},
            },
