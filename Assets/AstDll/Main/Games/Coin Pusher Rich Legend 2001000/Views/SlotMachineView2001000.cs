...
namespace CoinPusherRichLegend2001000 {
    public class SlotMachineView2001000 : SlotMachineViewBase
    {

        //FguiGObjectPoolHelper gobjPool = new FguiGObjectPoolHelper();

        const string MARK_POOL_GOBJ_2001000 = nameof(MARK_POOL_GOBJ_2001000);

        const string MARK_POOL_GAMEOBJ_2001000 = nameof(MARK_POOL_GAMEOBJ_2001000);

        public override void ShowSymbolHitEffect(int colIndex, int rowIndex, string symbolName, bool isAmin = true)
        {

            GComponent gSymbolHit = FguiGObjectPoolHelper.Instance.GetObject(symbolName, TagPoolGObject.SymbolHit, MARK_POOL_GOBJ_2001000).asCom;
