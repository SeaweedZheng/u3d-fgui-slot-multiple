...
using UnityEngine;
using System;
namespace PanelCoinPusher1100000
{

    public class PanelBaseController : MonoBehaviour, IPanel
    {
        const string pkgName = nameof(PanelCoinPusher1100000);
        enum PopState
        {
            None,
            Change,
        ...
        public virtual void Init(EventData res = null)
        {
            ...
            if (gOwnerPanel != _goAnchorPanel && _goAnchorPanel != null)
            {
                ...
                {
                    ResourceManager02.Instance.LoadAssetBundleAsync("Assets/AstBundle/Games/Panel Coin Pusher 1100000/FGUIs", (ab) =>
                    {
