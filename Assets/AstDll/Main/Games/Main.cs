...
public class Main
{
    ...
    private static void ConnectHardward()
    {
        ...
        if (ApplicationSettings.Instance.isMachine)
        {
            ...
            */
            ...
            SBoxInit02.Instance.Init(ApplicationSettings.Instance.machineDebugUrl, () =>
    ...
    static void InitSettings()
    {
        ...
        GameObject pagePrefab =
            ResourceManager.Instance.LoadAssetAtPathOnce<GameObject>("Assets/AstBundle/_Commons/Game Maker/Prefabs/INSTANCE.prefab");
    ...
    static void OnInitSettingFinish()
    {
        ...
        #region 参数获取成功后
        TestManager.Instance.Init($"Ver {ApplicationSettings.Instance.appVersion}/{GlobalModel.hotfixVersion}");
