...
public class Test02 : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        ResourceManager02.Instance.LoadAsset<GameObject>("Assets/AstBundle/_Commons/Game Maker/Prefabs/INSTANCE.prefab", (pref) =>
        {
        ...
        PageManager.Instance.OpenPage(PageName.PusherEmperorsReinPopupGameLoading);
        // 默认打开管理后台
    ...
    {
        [I18nLang.en] = "Assets/AstBundle/Consoles/ConsoleAbs/lang_en.xml",
        [I18nLang.cn] = "Assets/AstBundle/Consoles/ConsoleAbs/lang_cn.xml",
        [I18nLang.tw] = "Assets/AstBundle/Consoles/ConsoleAbs/lang_tw.xml",
    };
    ...
    async void ShowJson()
    {
        TextAsset jsn = await ResourceManager02.Instance.LoadAssetAsync<TextAsset>("Assets/AstBundle/_Commons/Game Maker/ABs/G152/Datas/game_info_g152.json");
